...
/*        if (monitorCount == 0)
    ...
    public final void wait(long timeout) throws InterruptedException {
      ...
      int tempMonitorCount = monitorCount;
      int tempThreadId = holdingThreadId;
      Thread thread=Thread.currentThread();
      if (thread.interrupted())
        throw new InterruptedException();
      thread.blockingObject=this;
      // No atomic wrapping because this is already an atimic instruction 
      monitorCount = 0;
      CProver.assume(Thread.currentThread().blockingObject == null);
      CProver.atomicBegin();
      monitorCount = tempMonitorCount;
      holdingThreadId = tempThreadId;
      CProver.atomicEnd();
    }
    ...
    // Our current implementation assumes that the code was generated by java
    // (as opposed to bytecode), therefore monitorexit can never throw because
    // monitorenter would have.
